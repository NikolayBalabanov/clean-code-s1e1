...
const addButton = document.querySelector('.form__btn'); //first button
...
const taskCompleted = function() {
    ...
    const listItem = this.parentNode;
    const listlabel = listItem.querySelector('.tasks__label');
...
const taskIncomplete = function() {
    ...
    const listItem = this.parentNode;
    const listlabel = listItem.querySelector('.tasks__label');
    listlabel.classList.remove('completed')
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem, taskCompleted);
}
...
const bindTaskEvents = function(taskListItem,checkBoxEventHandler) {
    ...
    const checkBox = taskListItem.querySelector('.tasks__check');
    const editButton = taskListItem.querySelector('.tasks__edit');
    const deleteButton = taskListItem.querySelector('.tasks__delete');
